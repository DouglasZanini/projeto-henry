                ...
                <tbody class="bg-white divide-y divide-gray-100 text-sm text-gray-700">
                    @foreach ($departamentos as $departamento)
                        <tr>
                            ...
                            <td class="px-6 py-4">{{ $departamento->localizacao }}</td>
                            <td class="px-6 py-4 flex items-center justify-center gap-3">
                                <button class="text-indigo-600 hover:text-indigo-800 font-semibold transition duration-150 view-departamento" data-id="{{ $departamento->id }}">Visualizar</button>
        ...
        <div class="bg-white rounded-xl shadow-xl w-full max-w-md p-6 relative animate-fade-in">
            ...
            <form id="departamento-form" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nome" id="departamento-nome" class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-50 text-sm px-4 py-2">
                </div>

                <div class="mb-4">
                    <label for="departamento-localizacao" class="block text-sm font-medium text-gray-700">Localização</label>
                    <input type="text" name="localizacao" id="departamento-localizacao" class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-50 text-sm px-4 py-2">
                </div>
